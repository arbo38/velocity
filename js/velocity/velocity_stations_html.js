...
var informationStation = {
	...
	setCapacity: function setCapacity() {
		$("#info-station-capacity").text(currentStation.bike_stands);
	},
	setAvailableBikes: function setAvailableBikes() {
	...
	setAvailableStands: function setAvailableStands() {
		// Removing previous labels
	...
	enableActionButton: function enableActionButton(param) {
		if (param === true) {
